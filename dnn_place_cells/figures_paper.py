...
def unit_visualization_by_type():
    config_version = 'small_world_2d_vgg16_block5_pool'#'env28_r24_2d_vgg16_fc2'
    ...
    # mine, I save the model reps as reshaped already
    ...
    for unit_type in [
        ...
        print(f"Plotting {unit_type}")
        
        if unit_type == 'place_cell':
            # Less directional place fields
            selected_n_indices = [2672, 315, 758, 3530] #[1280, 2672, 315, 758, 3429, 3530]
            # subplot_label = 'A'
        ...
        if unit_type == 'directional_cell':
            ...
            selected_n_indices = [245, 1303, 1081, 1499]
            # subplot_label = 'B'
        ...
        plt.savefig(f'figs/unit_visualization_by_type_{unit_type}_{config_version}.png')
        plt.close()
